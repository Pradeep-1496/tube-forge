...
<body style="margin:0;width:1080px;height:1920px;background:#000;${bgCss}display:flex;justify-content:center;align-items:center;font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display',sans-serif;position:relative;overflow:hidden;">
