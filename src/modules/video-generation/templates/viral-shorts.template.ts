...
<body style="margin:0;width:1080px;height:1920px;background-color:#18181b;${bgCss}display:flex;justify-content:center;align-items:center;font-family:Montserrat,sans-serif;position:relative;overflow:hidden;">
